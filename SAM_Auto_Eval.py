...
model_type = "vit_b"
device = "cuda"
sam_checkpoint = "/root/segment-anything-2/checkpoints/sam_vit_b_01ec64.pth"
...
if __name__ == '__main__':
    ...
    print(ANNOTATION_PATH, sam_checkpoint)
    # ------------------------ Load SAM2 model ------------------------
    ...
    # ------------------------- Save the results -------------------------
    with open("SAM_auto_test.json", "w") as f:
        json.dump(dataset_results, f)

    # ------------------------- Evaluate the results ---------------------
    cocoDt = cocoGT.loadRes("SAM_auto_test.json")
